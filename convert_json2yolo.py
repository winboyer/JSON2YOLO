...
def convert_coco_json(image_dir="../coco/images/", json_dir="../coco/annotations/", use_segments=False, cls91to80=False):
    ...
    for json_file in sorted(Path(json_dir).resolve().glob("*.json")):
        ...
        for shape in data['shapes']:
            ...
            # Write
            with open((fn / image_file_name).with_suffix(".txt"), "a") as file:
...
if __name__ == "__main__":
    ...
    if source == "COCO":
        convert_coco_json(
            "/Users/jinyfeng/projects/ai-construction/wuliao_train_val_images",
            "/Users/jinyfeng/projects/ai-construction/wuliao_train_val_labels",  # directory with *.json
            use_segments=False,
            cls91to80=False,
        )
